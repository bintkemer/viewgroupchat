...
public class mymyClientHandler implements Runnable{
    public static ArrayList<mymyClientHandler> clientHandlers = new ArrayList<>();
    private Socket socket;
    private BufferedReader bufferedReader;
    private BufferedWriter bufferedWriter;
    private String clientUsername;
    public mymyClientHandler(Socket socket) {
        try {
            this.socket = socket;
            ...
            broadcastMessage("SERVER RESPONSE: " + clientUsername + " has entered the chat!");
        } catch (IOException e) {
    ...
    public void broadcastMessage(String messageToSend) {
        for (mymyClientHandler clientHandler : clientHandlers) {
            try {
    ...
    public void removeClientHandler() {
        ...
        broadcastMessage("SERVER RESPONSE: " + clientUsername + " has left the chat!");
    }
